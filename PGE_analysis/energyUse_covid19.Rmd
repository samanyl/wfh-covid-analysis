...
eplt <- 
  ggplot(electric_Q1,aes(x=MONTH,y=SUMKWH,fill=YEAR_CUSTOMERCLASS)) +
  scale_fill_manual(values=c("#b2dffb","#fbc1bc","#4f98ca","#e58a8a")) +
  geom_bar(stat="identity",position=position_dodge()) +
  ggtitle("2019 vs 2020 Total Electric Usage in the Bay Area") +
  theme_minimal()
...
eplt2 <- 
  ...
  scale_fill_manual(values=c("#b2dffb","#fbc1bc","#4f98ca","#e58a8a")) +
  geom_bar(stat="identity",position=position_dodge()) +
  ggtitle("2019 vs 2020 Average Electric Usage in the Bay Area") +
  theme_minimal()
...
gplt <- 
  ...
  scale_fill_manual(values=c("#b2dffb","#fbc1bc","#4f98ca","#e58a8a")) +
  geom_bar(stat="identity",position=position_dodge()) +
  ggtitle("2019 vs 2020 Total Gas Usage in the Bay Area") +
  theme_minimal()
...
gplt2 <- 
  ...
  scale_fill_manual(values=c("#b2dffb","#fbc1bc","#4f98ca","#e58a8a")) +
  geom_bar(stat="identity",position=position_dodge()) +
  ggtitle("2019 vs 2020 Average Gas Usage in the Bay Area") +
  theme_minimal()
